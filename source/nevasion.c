...
static mvlist_t *move_to_dest      (mvlist_t      *list,
                                    int            dest,
                                    const sdata_t *sdata);
static mvlist_t *move_to_desta     (mvlist_t      *list,
                                    int            dest,
                                    const sdata_t *sdata,
                                    tbase_t       *tbase);
static mvlist_t *move_to_destb     (mvlist_t      *list,
                                    int            dest,
                                    const sdata_t *sdata );
static mvlist_t *move_to_destc     (mvlist_t      *list,
                                    int            dest,
                                    const sdata_t *sdata );
        ...
        //移動合いがあれば着手に追加
            ...
            // -----------------------------------------------
                ...
                if(next_ou){
                    ...
                    mvlist = move_to_destc(mvlist, dest, sdata);
            }
...
mvlist_t *move_to_desta       (mvlist_t *list,
                               int dest,
                               const sdata_t *sdata,
                               tbase_t       *tbase  )
{
...
mvlist_t *move_to_destb       (mvlist_t      *list,
                               int            dest,
                               const sdata_t *sdata )
{
    mvlist_t *mvlist = list;
...
mvlist_t *move_to_destc       (mvlist_t      *list,
                               int            dest,
                               const sdata_t *sdata )
{
    mvlist_t *mvlist = list;
